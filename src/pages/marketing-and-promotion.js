      ...
      >
        ...
        <Stack alignItems={"center"} spacing={4} position={"relative"}>
          ...
          <Stack
            ...
            position={"relative"}
          >
            <Typography fontWeight={600}>Research</Typography>
            <Box component={"img"} src="/mkt-3-1.png" width={"100%"}></Box>
          </Stack>
          <Stack
            p={2}
            bgcolor={"rgb(23, 23, 23)"}
          ...
          >
            ...
            <Box component={"img"} src="/mkt-3-2.png" width={"100%"}></Box>
          </Stack>
        </Stack>
        <Stack
          alignItems={"center"}
          ...
          >
            <Stack spacing={4} p={"5%"} alignItems={"center"}>
              ...
              <ButtonCustom
                onClick={() =>
                  window.open(
                    "https://x.com/0xMegamus/status/1816440626281619670",
                    "_blank"
                  )
                }
              >
